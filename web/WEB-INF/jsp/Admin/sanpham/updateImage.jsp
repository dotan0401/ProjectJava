                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <jsp:include page="../topbar.jsp"></jsp:include>
                        ...
                        <div class="container-fluid">
                            ...
                            <!-- DataTales Example -->
                        <form:form action="updateImage" modelAttribute="anh" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Mã</label>
                                <input readonly="true" value="${anh.id}" type="text" name="id" class="col-md-6 form-control" >
                                <label>Chọn Ảnh</label>
                                
                                <input style="margin: 20px 0 20px 0" value="" type="file" name="multipartFile" ><br>
