                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div style="display: flex">
                                    ...
                                    <div>
                                        <button  style="margin:20px 0 0 20px" class="btn btn-primary" ><a style="color: white;text-decoration: none" href="${pageContext.request.contextPath}/Admin/hangsanxuat/addnew">Thêm mới</a></button>
                                </div>
                                        ...
                                        <c:forEach items="${vaitro}" var="vt">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><fmt:formatDate value="${vt.ngayTao}" pattern=" HH:mm (dd-MM-yyyy)" /></td>
                                                    <td><fmt:formatDate value="${vt.ngayCapNhat}" pattern="HH:mm (dd-MM-yyyy)" /></td>
                                                </tr>
                                            </tbody>
                                        </c:forEach>
                                    </table>
